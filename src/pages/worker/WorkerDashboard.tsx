...
import { User, DollarSign, Calendar, Star, Settings, LogOut, MessageSquare } from "lucide-react";
...
const WorkerDashboard = () => {
  ...
  const inProgressBookings = myBookings.filter(b => b.status === 'in_progress').length;
