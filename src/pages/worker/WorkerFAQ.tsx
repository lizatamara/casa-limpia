...
const WorkerFAQ = () => {
  const faqsByCategory = appState.workerFAQs.reduce((acc, faq) => {
    if (!acc[faq.category]) {
      acc[faq.category] = [];
    }
    acc[faq.category].push(faq);
    return acc;
  }, {} as Record<string, typeof appState.workerFAQs>);
  ...
  return (
    <div className="min-h-screen bg-gradient-subtle">
      ...
      <div className="container mx-auto px-4 py-6 max-w-4xl">
        <Card>
          <CardHeader>
            <CardTitle>Centro de Ayuda para Trabajadores</CardTitle>
          </CardHeader>
          <CardContent>
